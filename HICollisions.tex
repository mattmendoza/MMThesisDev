...
\begin{figure}[htbp!]
  \centering
    ...
    \rule{35em}{0.5pt}
  \caption[Particle separation in the TOF]{charge/momentum vs Time of Flight and corresponding particle separation in the TOF.\citep{tofchargemom}. Pions, kaons, protons, and deuteron signals are labeled. Other signals corresponding to shorter flight times in the plot are leptons, the closest to the pion signal are muons, followed by electrons.}
